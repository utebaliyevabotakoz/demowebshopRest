...
//                .header("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8")
    ...
    @Test
    void findDiamondTest() {

        given()

                .when()
                .get("/catalog/searchtermautocomplete?term=diamond")
                .then()
                .log().all()
                .statusCode(200)
                .body("label",hasToString("[Black & White Diamond Heart, Diamond Pave Earrings, Diamond Tennis Bracelet, Vintage Style Three Stone Diamond Engagement Ring]") );
    }
